...
def make_background_loop():
    if pygame.mixer.get_init() is None:
        return None
    notes = [280, 280, 210, 220, 250, 250, 220, 210, 185, 185, 185, 220, 280, 280, 250, 220, 210, 210, 210, 220, 250, 250, 280, 280, 220, 220, 185, 185, 185, 185, 185, 185, 250, 250, 250, 300, 380, 380, 330, 300, 280, 280, 280, 220, 280, 280, 250, 220, 210, 210, 210, 220, 250, 250, 280, 280, 220, 220, 185, 185, 185, 185, 185, 185]
    piece = []
...
def main():
    ...
    bomb_sound = make_noise_sound(0.28, 0.28)
